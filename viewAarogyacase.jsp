...
PreparedStatement pstmt = con.prepareStatement("select * from patient where Arid =?");
pstmt.setInt(1,Credentials.getArid());
...
<td><a href ="DeleteAarogyaCase.jsp?Pid=<%=resultSet.getString(1)%>">Delete</a></td>
